...
struct _Evas_Func
{
   ...
   Eina_Bool (*image_content_zone_get)     (void *engine, void *image, Eina_Rectangle *content);
   Eina_Bool (*image_stretch_zone_get)     (void *engine, void *image, uint8_t **horizontal, uint8_t **vertical);
