...
static Eina_Bool
eng_image_content_zone_get(void *engine EINA_UNUSED, void *image, Eina_Rectangle *content)
{
   RGBA_Image *im = image;
...
static Eina_Bool
eng_image_stretch_zone_get(void *engine EINA_UNUSED, void *image,
                           uint8_t **horizontal, uint8_t **vertical)
{
   ...
   if (!im->cache_entry.stretch.horizontal.zone ||
       !im->cache_entry.stretch.vertical.zone)
     return EINA_FALSE;

   *horizontal = im->cache_entry.stretch.horizontal.zone;
   *vertical = im->cache_entry.stretch.vertical.zone;
   return EINA_TRUE;
}
...
static Evas_Func func =
{
     ...
     eng_image_content_zone_get,
     eng_image_stretch_zone_get,
